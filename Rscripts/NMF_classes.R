...
data <- read_excel("/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/pathogenic_classes_input.xlsx")
...
annotations <- as.data.frame(read_excel("/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/pathogenic_classes_labels.xlsx", col_types = column_types))
...
saveRDS(estim.r, file = '/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/estimr_results2806_1.rds')
...
custom_colors <- c("pathogenic" = "red",
                   "benign" = "green")
...
saveRDS(nmf_fit, file = '/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank7/nmf_fit2806_rank7_1.rds')
nmf_fit <- readRDS(file = "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank7/nmf_fit2806_rank7_1.rds")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank7/nmf_results_coeflabels_2806_1.xlsx")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank7/coef_norm_2806_1.xlsx")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank7/coef_fit_2806_1.xlsx")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank7/basis_fit_2806_1.xlsx")
...
saveRDS(nmf_fit, file = '/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank4/nmf_fit2806_rank4_1.rds')
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank4/nmf_results_labels_2806_1.xlsx")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank4/coef_norm_2806_1.xlsx")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank4/coef_fit_2806_1.xlsx")
...
# Save workbook
saveWorkbook(wb, "/Users/fakias0a/Documents/karla_thesis/normalized/updated_2706/results_NMF/4/rank4/basis_fit_2806_1.xlsx")
